...
/**
 * <h1> Order</h1>
 * The class for representing each of order in the front of house
 *
 * @author  Anh Pham
 * @version 0.4
 * @since   2017-03-24
 */
public class FOHOrder
{
    // The preset status
     ...
     */
    public FOHOrder(String orderID, String bookingID, String tableID, String menuItemID, String comment)
    {
     ...
     */
    public FOHOrder(String orderID, String bookingID, String tableID, String menuItemID, String comment, int status)
    {
        this.orderID = orderID;
        this.bookingID = bookingID;
        this.tableID = tableID;
     ...
     */
    public FOHOrder(String orderID, String bookingID, String tableID, String menuItemID, String comment, int status, Timestamp eTP)
    {
        this.orderID = orderID;
        this.bookingID = bookingID;
        this.tableID = tableID;
    ...
    /**
     * Method for getting the ID of the booking associated
