...
class KABStationServer
{
     ...
     */
    KABStationServer(int portNum, KABStationInstance kabStationInstance)
    {
    ...
    /**
     * The class representing each thread of a client
     */
    private class ClientServiceThread extends Thread
    {
        ...
        public void run()
        {
            ...
            try
            {
                ...
                Callable<String> workerThread = new KABStationInstanceWorkerThreadCallable(clientCommand, kABStationInstance);
                out.writeUTF(kABStationInstance.getExecutor().submit(workerThread).get());
                out.flush();
