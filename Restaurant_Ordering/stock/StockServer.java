    ...
    class ClientServiceThread extends Thread
    {
        ...
        public void run()
        {
            ...
            try
            {
                ...
                Callable<String> workerThread = new StockWorkerThreadCallable(clientCommand);
                out.writeUTF(stockManager.getExecutor().submit(workerThread).get());
                out.flush();
            }
            catch (Exception e)
            {
