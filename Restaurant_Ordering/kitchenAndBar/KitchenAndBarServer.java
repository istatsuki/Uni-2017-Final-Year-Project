...
class KitchenAndBarServer
{
     ...
     */
    KitchenAndBarServer(int portNum)
    {
        try
        {
    ...
    class ClientServiceThread extends Thread
    {
        ...
        public void run()
        {
            ...
            try
            {
                ...
                Callable<String> workerThread = new KABWorkerThreadCallable(clientCommand);
                out.writeUTF(kitchenAndBar.getExecutor().submit(workerThread).get());
                out.flush();
